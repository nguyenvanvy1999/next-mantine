...
export default function DashboardPage() {
    ...
    const stats = [
        ...
        { label: 'Active Sessions', value: '456', icon: IconRocket, color: 'green' },
    ...
    return (
        <Container fluid>
            <Stack gap="lg">
                ...
                >
                    <Stack gap="xs">
                        ...
                        <Text c="white" opacity={0.9} maw={600}>
                            This is the starting point for your new application. You have a clean slate to build something amazing.
                            Start by exploring the documentation or configuring your settings.
                        </Text>
                        <Group mt="md">
                            <Button
                                variant="white"
                ...
                <Surface component={Paper} p="md" radius="md" style={{ minHeight: 400 }}>
                    <Title order={4} mb="md">
                        Recent Activity
                    </Title>
